...
.. code-block:: ocaml
  ...
  let () =
    ...
    Atdgen_extra_runtime.Util.Biniou.to_file Tree_b.write_tree fname tree;
...
.. code-block:: ocaml
  ...
  let () =
    Atdgen_extra_runtime.Util.Json.to_channel Part3_j.write_t3 stdout v;
    print_newline ()
  ...
  let validate fname =
    let x =
      try
        ...
        let x = Atdgen_extra_runtime.Util.Json.from_file Config_j.read_config fname in
...
.. code-block:: ocaml
  ...
  # #require "atdgen";;
  # #load "untypable.cma";;
  # Atdgen_extra_runtime.Util.Json.from_channel Untypable_j.read_obj_list stdin;;
  [
    {
      "label": "flower",
      "value": {
