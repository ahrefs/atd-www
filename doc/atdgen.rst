...
.. code:: ocaml
    ...
    val validate_gender :
      Atdgen_extra_runtime.Util.Validation.path -> gender -> Atdgen_extra_runtime.Util.Validation.error option
    ...
    val validate_profile :
      Atdgen_extra_runtime.Util.Validation.path -> profile -> Atdgen_extra_runtime.Util.Validation.error option
...
``Atdgen_extra_runtime.Json_adapter.S``, which is:
...
``Atdgen_extra_runtime.Json_adapter`` provides a few modules and functors that
...
.. code:: ocaml
    ...
    type document = [
      | Image of image
      | Text of text
    ] <json adapter.ocaml="Atdgen_extra_runtime.Json_adapter.Type_field">
...
.. code:: ocaml
    ...
    val validate_t : Atdgen_extra_runtime.Util.Validation.path -> t -> Atdgen_extra_runtime.Util.Validation.error option
...
.. code:: ocaml
    ...
    | Some e ->
        Printf.eprintf "Error: %s\n%!"
          (Atdgen_extra_runtime.Util.Validation.string_of_error e)
    ...
    type positive = int <ocaml validator="
      fun path x ->
        if x > 0 then None
          ...
          Some (
            Atdgen_extra_runtime.Util.Validation.error
