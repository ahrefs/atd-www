...
let string_of__1 ?(len = 1024) x =
  ...
  Bi_outbuf.contents ob
let get__1_reader = (
  get_poly_reader Atdgen_www_runtime.Ob_run.get_int_reader Atdgen_www_runtime.Ob_run.read_int Atdgen_www_runtime.Ob_run.get_int_reader Atdgen_www_runtime.Ob_run.read_int
)
let read__1 = (
  read_poly Atdgen_www_runtime.Ob_run.get_int_reader Atdgen_www_runtime.Ob_run.read_int Atdgen_www_runtime.Ob_run.get_int_reader Atdgen_www_runtime.Ob_run.read_int
)
...
let string_of__4 ?(len = 1024) x =
  ...
  Bi_outbuf.contents ob
let get__4_reader = (
  get_poly_reader Atdgen_www_runtime.Ob_run.get_int_reader Atdgen_www_runtime.Ob_run.read_int get__3_reader read__3
)
let read__4 = (
  read_poly Atdgen_www_runtime.Ob_run.get_int_reader Atdgen_www_runtime.Ob_run.read_int get__3_reader read__3
)
  ...
  fun tag ->
    if tag <> 21 then Atdgen_www_runtime.Ob_run.read_error () else
      fun ib ->
        ...
        if !bits0 <> 0x3 then Atdgen_www_runtime.Ob_run.missing_fields [| !bits0 |] [| "test0"; "test1" |];
        (
          {
            test0 = !field_test0;
            test1 = !field_test1;
...
let string_of__2 ?(len = 1024) x =
  ...
  Bi_outbuf.contents ob
let get__2_reader = (
  get_poly_reader Atdgen_www_runtime.Ob_run.get_int_reader Atdgen_www_runtime.Ob_run.read_int Atdgen_www_runtime.Ob_run.get_string_reader Atdgen_www_runtime.Ob_run.read_string
)
let read__2 = (
  read_poly Atdgen_www_runtime.Ob_run.get_int_reader Atdgen_www_runtime.Ob_run.read_int Atdgen_www_runtime.Ob_run.get_string_reader Atdgen_www_runtime.Ob_run.read_string
)
