  ...
  Atdgen_extra_runtime.Oj_run.read_with_adapter Json_adapters.Identity.normalize (
    fun p lb ->
      ...
      with Yojson.End_of_object -> (
          (
            {
              ambiguous = (match !field_ambiguous with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "ambiguous");
              not_ambiguous2 = (match !field_not_ambiguous2 with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "not_ambiguous2");
            }
           : ambiguous')
        )
  )
  ...
  fun p lb ->
    ...
    with Yojson.End_of_object -> (
        (
          {
            ambiguous = (match !field_ambiguous with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "ambiguous");
            not_ambiguous1 = (match !field_not_ambiguous1 with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "not_ambiguous1");
          }
         : ambiguous)
      )
)
