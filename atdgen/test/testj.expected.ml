...
let write__19 write__a = (
  Atdgen_extra_runtime.Oj_run.write_list (
    write__a
  )
)
...
let read__19 read__a = (
  Atdgen_extra_runtime.Oj_run.read_list (
    read__a
  )
)
...
let rec read_p' read__a = (
  fun p lb ->
    ...
    match Yojson.Safe.start_any_variant p lb with
      | `Edgy_bracket -> (
          match Yojson.Safe.read_ident p lb with
            | "A" ->
              ...
              (A : 'a p')
            | "Bb" ->
              Atdgen_extra_runtime.Oj_run.read_until_field_value p lb;
              let x = (
                  read_p' read__a
                ) p lb
              in
            ...
            | "Ccccc" ->
              ...
              (Ccccc x : 'a p')
            | x ->
              Atdgen_extra_runtime.Oj_run.invalid_variant_tag p x
        )
      | `Double_quote -> (
      ...
      | `Square_bracket -> (
          match Atdgen_extra_runtime.Oj_run.read_string p lb with
            | "Bb" ->
              Yojson.Safe.read_space p lb;
        ...
        match i with
          | 0 ->
            field_a := (
              Some (
                (
                  Atdgen_extra_runtime.Oj_run.read_int
                ) p lb
              )
            );
          | 1 ->
            field_b := (
              Some (
                (
                  Atdgen_extra_runtime.Oj_run.read_bool
                ) p lb
              )
            );
          | 2 ->
...
" s loc) "File \"test.atd\", line 25, characters 9-96" (String.sub s pos len); -1
    ...
    with Yojson.End_of_object -> (
        (
          {
            a = (match !field_a with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "a");
            b = (match !field_b with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "b");
            c = (match !field_c with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "c");
          }
         : r)
      )
)
...
let rec write__20 write__a write__b ob x = (
  Atdgen_extra_runtime.Oj_run.write_option (
...
" s loc) "File \"test.atd\", line 143, characters 21-71" (String.sub s pos len); -1
    ...
    with Yojson.End_of_object -> (
        (
          {
            fst = (match !field_fst with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "fst");
            snd = (match !field_snd with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "snd");
          }
         : ('x, 'y) poly)
      )
)
      ...
      | `Edgy_bracket -> (
          match Yojson.Safe.read_ident p lb with
            ...
            | "Case3" ->
              Atdgen_extra_runtime.Oj_run.read_until_field_value p lb;
              let x = (
                  Atdgen_extra_runtime.Oj_run.read_string
                ) p lb
              in
              Yojson.Safe.read_space p lb;
              Yojson.Safe.read_gt p lb;
      ...
      let f =
        fun s pos len ->
          ...
          if len = 6 && String.unsafe_get s pos = 'v' && String.unsafe_get s (pos+1) = 'a' && String.unsafe_get s (pos+2) = 'l' && String.unsafe_get s (pos+3) = '1' && String.unsafe_get s (pos+4) = '_' && String.unsafe_get s (pos+5) = 'x' then (
            ...
            (fun loc s -> Printf.eprintf "Warning: skipping field %s (def: %s)
" s loc) "File \"test.atd\", line 118, characters 12-165" (String.sub s pos len); -1
          )
      in
      let i = Yojson.Safe.map_ident p f lb in
      Atdgen_extra_runtime.Oj_run.read_until_field_value p lb;
...
" s loc) "File \"test.atd\", line 118, characters 12-165" (String.sub s pos len); -1
    ...
    with Yojson.End_of_object -> (
        (
          {
            val1_x = (match !field_val1_x with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "val1_x");
          }
         : val1)
      )
)
...
" s loc) "File \"test.atd\", line 121, characters 12-57" (String.sub s pos len); -1
    ...
    with Yojson.End_of_object -> (
        (
          {
            val2_x = (match !field_val2_x with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "val2_x");
            val2_y = !field_val2_y;
          }
         : val2)
      )
...
let write__29 = (
  Atdgen_extra_runtime.Oj_run.write_list (
    Atdgen_extra_runtime.Oj_run.write_float_as_int
  )
)
...
let read__29 = (
  Atdgen_extra_runtime.Oj_run.read_list (
    Atdgen_extra_runtime.Oj_run.read_number
  )
)
let _29_of_string s =
...
let write__3 = (
  Atdgen_extra_runtime.Oj_run.write_nullable (
    Yojson.Safe.write_int
  )
)
...
let read_date = (
  fun p lb ->
    ...
    (try
      ...
      (x0, x1, x2)
    with Yojson.End_of_tuple ->
      Atdgen_extra_runtime.Oj_run.missing_tuple_fields p !len [ 0; 1; 2 ]);
)
let date_of_string s =
  read_date (Yojson.Safe.init_lexer ()) (Lexing.from_string s)
let write__9 = (
  Atdgen_extra_runtime.Oj_run.write_array (
    Yojson.Safe.write_string
  )
)
let string_of__9 ?(len = 1024) x =
  ...
  Buffer.contents ob
let read__9 = (
  Atdgen_extra_runtime.Oj_run.read_array (
    Atdgen_extra_runtime.Oj_run.read_string
  )
)
let _9_of_string s =
...
let read__10 = (
  Atdgen_extra_runtime.Oj_run.read_list (
    Atdgen_extra_runtime.Oj_run.read_null
  )
)
let _10_of_string s =
...
let write_mixed_record : _ -> mixed_record -> _ = (
  fun ob (x : mixed_record) ->
    ...
    (
      Atdgen_extra_runtime.Oj_run.write_int64
    )
      ob x.field3;
    if !is_first then
      is_first := false
    ...
    (
      fun ob x ->
        ...
        (
          Atdgen_extra_runtime.Oj_run.write_int8
        ) ob x
        );
        Buffer.add_char ob ',';
        ...
        (
          Atdgen_extra_runtime.Oj_run.write_int32
        ) ob x
        );
        Buffer.add_char ob ',';
        ...
        match i with
          ...
          | 3 ->
            field_field3 := (
              Some (
                (
                  Atdgen_extra_runtime.Oj_run.read_int64
                ) p lb
              )
            );
          | 4 ->
                  ...
                  fun p lb ->
                    ...
                    (try
                      ...
                      let x2 =
                        let x =
                          (
                            Atdgen_extra_runtime.Oj_run.read_int8
                          ) p lb
                        in
                        incr len;
                        Yojson.Safe.read_space p lb;
                      ...
                      let x4 =
                        let x =
                          (
                            Atdgen_extra_runtime.Oj_run.read_int32
                          ) p lb
                        in
                        incr len;
                        Yojson.Safe.read_space p lb;
                      ...
                      (x0, x1, x2, x3, x4, x5)
                    with Yojson.End_of_tuple ->
                      Atdgen_extra_runtime.Oj_run.missing_tuple_fields p !len [ 0; 1; 2; 3; 4; 5 ]);
                ) p lb
              )
            );
          | 10 ->
        ...
        (
          {
            field0 = !field_field0;
            field1 = !field_field1;
            field2 = (match !field_field2 with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "field2");
            field3 = (match !field_field3 with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "field3");
            field4 = (match !field_field4 with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "field4");
            field5 = !field_field5;
            field6 = !field_field6;
            field7 = (match !field_field7 with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "field7");
            field8 = (match !field_field8 with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "field8");
            field9 = (match !field_field9 with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "field9");
            field10 = (match !field_field10 with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "field10");
            field11 = !field_field11;
            field12 = (match !field_field12 with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "field12");
            field13 = (match !field_field13 with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "field13");
            field14 = (match !field_field14 with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "field14");
          }
         : mixed_record)
      )
)
  ...
  Atdgen_extra_runtime.Oj_run.read_list (
    fun p lb ->
      ...
      (try
        ...
        (x0, x1)
      with Yojson.End_of_tuple ->
        Atdgen_extra_runtime.Oj_run.missing_tuple_fields p !len [ 0; 1 ]);
  )
)
let _14_of_string s =
        ...
        (
          {
            x0 = !field_x0;
            x1 = !field_x1;
            x2 = (match !field_x2 with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "x2");
            x3 = (match !field_x3 with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "x3");
            x4 = (match !field_x4 with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "x4");
          }
         : test)
      )
)
...
" s loc) "File \"test.atd\", line 204, characters 18-33" (String.sub s pos len); -1
    ...
    with Yojson.End_of_object -> (
        (
          {
            x294623 = (match !field_x294623 with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "x294623");
          }
         : _ generic)
      )
)
...
" s loc) "File \"test.atd\", line 190, characters 19-95" (String.sub s pos len); -1
    ...
    with Yojson.End_of_object -> (
        (
          {
            some_field = (match !field_some_field with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "some_field");
          }
         : some_record)
      )
)
...
" s loc) "File \"test.atd\", line 197, characters 17-140" (String.sub s pos len); -1
    ...
    with Yojson.End_of_object -> (
        (
          {
            sqrt2_5 = (match !field_sqrt2_5 with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "sqrt2_5");
            small_2 = (match !field_small_2 with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "small_2");
            large_2 = (match !field_large_2 with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "large_2");
          }
         : precision)
      )
)
...
let write__25 = (
  Atdgen_extra_runtime.Oj_run.write_assoc_list (
    write_id
  ) (
    Yojson.Safe.write_int
  )
...
let string_of__25 ?(len = 1024) x =
  ...
  Buffer.contents ob
let read__25 = (
  Atdgen_extra_runtime.Oj_run.read_assoc_list (
    read_id
  ) (
    Atdgen_extra_runtime.Oj_run.read_int
  )
...
let write__22 = (
  Atdgen_extra_runtime.Oj_run.write_assoc_array (
    Yojson.Safe.write_string
  ) (
    Yojson.Safe.write_int
  )
...
let string_of__22 ?(len = 1024) x =
  ...
  Buffer.contents ob
let read__22 = (
  Atdgen_extra_runtime.Oj_run.read_assoc_array (
    Atdgen_extra_runtime.Oj_run.read_string
  ) (
    Atdgen_extra_runtime.Oj_run.read_int
  )
...
" s loc) "File \"test.atd\", line 55, characters 14-71" (String.sub s pos len); -1
    ...
    with Yojson.End_of_object -> (
        (
          {
            f32 = (match !field_f32 with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "f32");
            f64 = (match !field_f64 with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "f64");
          }
         : floats)
      )
)
...
let read_extended_tuple = (
  fun p lb ->
    ...
    (try
      ...
      (x0, x1, x2, x3, x4, x5)
    with Yojson.End_of_tuple ->
      Atdgen_extra_runtime.Oj_run.missing_tuple_fields p !len [ 0; 1; 4 ]);
)
        ...
        fun s pos len ->
          ...
          if len = 2 && String.unsafe_get s pos = 'b' then (
            match String.unsafe_get s (pos+1) with
              ...
              | _ -> (
                  (fun loc s -> Printf.eprintf "Warning: skipping field %s (def: %s)
" s loc) "File \"test.atd\", line 103, characters 16-516" (String.sub s pos len); -1
                )
          )
          else (
            (fun loc s -> Printf.eprintf "Warning: skipping field %s (def: %s)
...
" s loc) "File \"test.atd\", line 103, characters 16-516" (String.sub s pos len); -1
    ...
    with Yojson.End_of_object -> (
        (
          {
            b0x = (match !field_b0x with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "b0x");
            b1x = (match !field_b1x with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "b1x");
            b2x = (match !field_b2x with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "b2x");
            b3x = !field_b3x;
            b4x = (match !field_b4x with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "b4x");
            b5x = !field_b5x;
          }
         : extended)
      )
...
" s loc) "File \"test.atd\", line 98, characters 12-40" (String.sub s pos len); -1
    ...
    with Yojson.End_of_object -> (
        (
          {
            b0 = (match !field_b0 with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "b0");
            b1 = (match !field_b1 with Some x -> x | None -> Atdgen_extra_runtime.Oj_run.missing_field p "b1");
          }
         : base)
      )
)
