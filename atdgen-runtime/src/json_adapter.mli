...
(** Module signature required of any json adapter.
    ...
    [<json
       adapter.ocaml="Atdgen_extra_runtime.Json_adapter.Type_field"]
    refers to the OCaml module
    [Atdgen_extra_runtime.Json_adapter.Type_field].
*)
module type S = sig
...
type obj = [
  | User of user
  | ...
] <json adapter.ocaml="Atdgen_extra_runtime.Json_adapter.One_field">
...
{[
module My_adapter = Atdgen_extra_runtime.Json_adapter.Type_and_value_fields.Make(
  struct
